  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-6">
      ...
      <p className="mt-3 text-slate-700">
        Use these support paths to solve common questions around affiliate links, shipping, policy, and category navigation.
      </p>
      <div className="mt-5 grid gap-3 md:grid-cols-2">
        ...
        <Link href="/affiliate-disclosure" className="rounded-lg border border-slate-200 p-4 hover:bg-slate-50">Affiliate Disclosure</Link>
